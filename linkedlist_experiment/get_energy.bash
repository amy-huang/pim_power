...
# pim
./master_script.bash arm15_HostCPUs.xml arm15_PimCPUs.xml linkedlist_experiment/pim-config.json linkedlist_experiment/pim-stats.txt cacti-out.txt pim linkedlist_experiment
